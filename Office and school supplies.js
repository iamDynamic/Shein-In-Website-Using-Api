...
body.onload = async () => {
  var feedProducts = await getFeedProducts(19327651);
 var feedProducts2 = await getFeedProducts(21027768);
 var feedProducts3 = await getFeedProducts(24442133);
 var feedProducts4 = await getFeedProducts(20469802)
 var feedProducts5 = await getFeedProducts(24324582)
 var feedProducts6 = await getFeedProducts(13426758)
 var feedProducts7 = await getFeedProducts(20419649)
 var feedProducts8 = await getFeedProducts(23115813)
 var feedProducts9 = await getFeedProducts(24208907)
