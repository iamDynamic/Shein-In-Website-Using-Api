...
body.onload = async () => {
 var feedProducts = await getFeedProducts(19259337);
 var feedProducts2 = await getFeedProducts(24659237);
 var feedProducts3 = await getFeedProducts(27019446);
 var feedProducts4 = await getFeedProducts(18529689)
 var feedProducts5 = await getFeedProducts(21770106)
 var feedProducts6 = await getFeedProducts(21027768)
 var feedProducts7 = await getFeedProducts(26301420)
 var feedProducts8 = await getFeedProducts(24829864)
 var feedProducts9 = await getFeedProducts(23730716)
