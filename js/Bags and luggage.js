...
body.onload = async () => {
var feedProducts = await getFeedProducts(21727498);
 var feedProducts2 = await getFeedProducts(24906029);
 var feedProducts3 = await getFeedProducts(10802543);
 var feedProducts4 = await getFeedProducts(11833433);
 var feedProducts5 = await getFeedProducts(15078866);
 var feedProducts6 = await getFeedProducts(27436656);
 var feedProducts7 = await getFeedProducts(19434907);
 var feedProducts8 = await getFeedProducts(24785497);
 var feedProducts9 = await getFeedProducts(24671361);
