...
body.onload = async () => {
 var feedProducts = await getFeedProducts(28215967);
 var feedProducts2 = await getFeedProducts(26321056);
 var feedProducts3 = await getFeedProducts(28587922);
 var feedProducts4 = await getFeedProducts(27965928)
 var feedProducts5 = await getFeedProducts(10391546)
 var feedProducts6 = await getFeedProducts(20627833)
 var feedProducts7 = await getFeedProducts(23861775)
 var feedProducts8 = await getFeedProducts(4095306)
 var feedProducts9 = await getFeedProducts(15541762)
