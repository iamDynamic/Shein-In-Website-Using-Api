...
body.onload = async () => {
  var feedProducts = await getFeedProducts(27019446);
 var feedProducts2 = await getFeedProducts(25723510);
 var feedProducts3 = await getFeedProducts(22782343);
 var feedProducts4 = await getFeedProducts(14139360)
 var feedProducts5 = await getFeedProducts(26606268)
 var feedProducts6 = await getFeedProducts(26919109)
 var feedProducts7 = await getFeedProducts(23827679)
 var feedProducts8 = await getFeedProducts(11984517)
 var feedProducts9 = await getFeedProducts(16576507)
